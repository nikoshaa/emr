                ...
                <div class="basic-form">
                    <form action="{{Route('pasien.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="alergi" class="form-control" rows="2" placeholder="Masukkan alergi pasien (jika ada)">{{old('alergi')}}</textarea>
                                @error('alergi')
                                <div class="invalid-feedback animated fadeInUp"
                                style="display: block;">{{$message}}</div>
                                @enderror
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">File General Uncent (max 5 files)</label>
                            <div class="col-sm-10">
